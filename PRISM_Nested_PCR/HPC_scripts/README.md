...
**NestedPCR_MasterScript.sh** is a master script to execute the data processing pipeline for the NestedPCR data (Figure 4 of Karimi et al., 2025). <br>
...
<br>
This script is for data processing of NGS files only. The downstrain analyses can be found in scripts/<br>
 <br>
