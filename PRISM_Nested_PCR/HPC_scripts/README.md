...
**NestedPCR_MasterScript.sh** is a master script to execute the data processing pipeline for the NestedPCR data (Figure 4 of Karimi et al., 2025). The pipeline was executed on a HPC cluster using the slurm file <br>
